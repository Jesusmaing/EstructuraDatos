...
public:
   ...
   */
    ...
    */
    ...
    /** @brief M&eacute;todo que realiza el algoritmo de fleury en cu&aacute;l realiza un paseo de euler.
     * @param id ID del nodo(v&eacute;rtice)
    */
    void Fleury(const T &id);
    /** @brief Funci&oacute;n que lee un archivo de texto para construir una gr&aacute;fica o grafo
     * @param grafica Archivo de texto que contendr&aacute; vertices y aristas
    */
    void Archivo(const char grafica[]);
